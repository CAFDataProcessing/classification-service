...
import com.github.cafdataprocessing.classification.service.tests.utils.EnvironmentPropertyProvider;
...
public class SwaggerIT {
    ...
    @Test(description = "Retrives the swagger contract from the classification service.")
     public void getContract() throws IOException {
        URL swaggerContractUrl = new URL(apiClient.getBasePath()+"/swagger.yaml");
        ...
        Assert.assertTrue(contractAsString.contains("title: \"Classification Service API\""), "Response should have the classification service title.");
    }

    @Test(description = "Retrives the swagger UI from the classification service.")
    public void getUI() throws IOException {
        String uiUrlPath = EnvironmentPropertyProvider.getHost()+"/classification-ui";
        ...
        Assert.assertTrue(uiAsString.contains("<title>CAF Service API</title>"), "Response should be the UI for the classification service.");
    }
