...
import static com.github.cafdataprocessing.classification.service.client.model.ConditionCommon.TypeEnum.EXISTS;
import static com.github.cafdataprocessing.classification.service.client.model.ConditionCommon.TypeEnum.TEXT;
...
public class AdditionalPropertyComparison {
    ...
    public static void compareAdditional(ConditionCommon.TypeEnum expectedType, ConditionCommon.TypeEnum retrievedType,
        ...
        switch(retrievedType){
            ...
            case DATE:
                ...
                break;
            case TERMLIST:
                if(expectedType.equals(TERMLIST)) {
                    compareTermListConditionAdditionals(
                            mapper.convertValue(expectedAdditional, TermlistConditionAdditional.class),
                            mapper.convertValue(retrievedAdditional, TermlistConditionAdditional.class)
                    );
                }
                else {
                    Assert.fail("Expected and retrieved additional properties are not instances of the same type. Retrieved is TERMLIST.");
                }
                break;
            case NOT:
                if(expectedType.equals(NOT)) {
    ...
    public static void compareTermListConditionAdditionals(TermlistConditionAdditional expectedAdditional,
                                                     TermlistConditionAdditional retrievedAdditional){
        Assert.assertEquals(retrievedAdditional.getValue(), expectedAdditional.getValue(),
                "Value on Term List condition should be expected value.");
        Assert.assertEquals(retrievedAdditional.getField(), expectedAdditional.getField(),
                "Field on Term List condition should be expected value.");
        Assert.assertEquals(retrievedAdditional.getOrder(), expectedAdditional.getOrder(),
                "Order on Term List condition should be expected value.");
    }
    ...
    public static void compareNotConditionAdditionals(NotConditionAdditional expectedAdditional,
        ...
        compareAdditional(((ConditionCommon)expectedCondition.getAdditional()).getType(),
