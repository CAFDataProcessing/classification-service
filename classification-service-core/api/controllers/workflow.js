...
function createWorkflow(req, response, next){
  ...
  logger.info(function(){return 'Creating Workflow using parameters: '+ JSON.stringify(createWorkflowParams);});
...
function deleteWorkflow(req, response, next){
  ...
  logger.info(function(){return 'Deleting Workflow using parameters: '+ JSON.stringify(deleteWorkflowParams);});
...
function getWorkflow(req, response, next){
  ...
  logger.info(function(){return 'Retrieving Workflow using parameters: '+ JSON.stringify(getWorkflowParams);});
...
function getWorkflows(req, response, next){
  ...
  logger.info(function(){return 'Retrieving Workflows using parameters: '+ JSON.stringify(getWorkflowsParams);});
...
function updateWorkflow(req, response, next){
  ...
  logger.info(function(){return 'Updating Workflow using parameters: '+ JSON.stringify(updateWorkflowParams);});
