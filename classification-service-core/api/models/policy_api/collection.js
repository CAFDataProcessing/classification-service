...
function get(projectId, collectionId, include_condition, include_children){
  ...
  return policyHttpHelper.genericPolicyAPIGetItemRequest("classification/retrieve", getCollectionParams);
}
...
function getCollections(projectId, pageNum, pageSize){
  ...
  return policyHttpHelper.genericPolicyAPIGetItemsRequest("classification/retrieve", getCollectionsParams);
}
...
function create(projectId, collection){
  ...
  return policyHttpHelper.genericPolicyAPIPostItemRequest("classification/create", createCollectionParams);
}
...
function update(projectId, collection){
  ...
  //note that undefined or null for policy_ids or condition will cause no change in them.
  ...
  return policyHttpHelper.genericPolicyAPIPostItemRequest("classification/update", updateCollectionParams);
}
function deleteCollection(projectId, collectionId){
  ...
  var deletePromise = policyHttpHelper.genericPolicyAPIPostItemRequest("classification/delete", deleteCollectionParams);
  
  var deferredDelete = Q.defer();
  deletePromise.then(function(deleteResult){
    httpHelper.handleDeleteResponseAndThrow(deleteResult);
