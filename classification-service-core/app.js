...
var logger = require('./api/logging/logging.js');
var appConfig = require('./api/config/classificationServiceConfig.js');
...
var logErrorToConsole = function(err, statusCode, statusMessage){
  //TODO can use 'dateformat' library if the format of log timestamp needs to be formatted.   
